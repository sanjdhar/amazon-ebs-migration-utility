...
1. Create an standard SNS topic using  default options in the same account and region as your DynamoDB table. Create an email subscription against this topic and note down the resource ARN.
